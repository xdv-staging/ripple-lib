...
/**
 * Retrieve this account's Divvy trust lines.
 *
 * To keep up-to-date with changes to the AccountRoot entry, subscribe to the
 ...
 * @param {string} address Divvy address
 ...
 *
 *  @param {Hex-encoded String|DivvyAddress} public_key
 *  @param {Function} callback
 *
 *  @callback
 *  @param {Error} err
...
/**
 *  Convert a hex-encoded public key to a Divvy Address
 *
 *  @static
 *
 *  @param {Hex-encoded string|DivvyAddress} public_key
 *  @returns {DivvyAddress}
 */
Account._publicKeyToAddress = function(public_key) {
  // Based on functions in /src/js/divvy/keypair.js
