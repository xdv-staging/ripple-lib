...
**[requestServerInfo([callback])](https://xdv.io/wiki/JSON_Messages#server_info)**
...
request.setServer('wss://s1.xdv.io');

request.request(function(err, res) {

});
```
**[requestPeers([callback])](https://xdv.io/wiki/JSON_Messages#peers)**

**[requestConnect(ip, port, [callback])](https://xdv.io/wiki/JSON_Messages#connect)**

**[unl_list([callback])](https://xdv.io/wiki/JSON_Messages#unl_list)**
...
**[unl_add(addr, comment, [callback])](https://xdv.io/wiki/JSON_Messages#unl_add)**

**[unl_delete(node, [callback])](https://xdv.io/wiki/JSON_Messages#unl_delete)**



##Ledger requests

**[requestLedger([opts], [callback])](https://xdv.io/wiki/JSON_Messages#ledger)**

**[requestLedgerHeader([callback])](https://wiki.xdv.io/JSON_Messages#ledger_data)**

**[requestLedgerCurrent([callback])](https://xdv.io/wiki/JSON_Messages#ledger_current)**

**[requestLedgerEntry(type, [callback])](https://xdv.io/wiki/JSON_Messages#ledger_entry)**

**[requestSubscribe([streams], [callback])](https://xdv.io/wiki/JSON_Messages#subscribe)**

Start receiving selected streams from the server.

**[requestUnsubscribe([streams], [callback])](https://xdv.io/wiki/JSON_Messages#unsubscribe)**

Stop receiving selected streams from the server.

##Account requests

**[requestAccountInfo(options, [callback])](https://xdv.io/wiki/JSON_Messages#account_info)**
...
**[requestAccountLines(options, [callback])](https://xdv.io/wiki/JSON_Messages#account_lines)**

**[requestAccountOffers(options, [callback])](https://xdv.io/wiki/JSON_Messages#account_offers)**
...
**[requestAccountTransactions(options, [callback])](https://xdv.io/wiki/JSON_Messages#account_tx)**
...
**[requestWalletAccounts(seed, [callback])](https://xdv.io/wiki/JSON_Messages#wallet_accounts)**

Return a list of accounts for a wallet. *Requires trusted remote*

**requestAccountBalance(account, [ledger], [callback])**

Get the balance for an account. Returns an [Amount](https://github.com/xdv/divvy-lib/blob/develop/src/js/divvy/amount.js) object.
...
**[requestBookOffers(options, [callback])](https://xdv.io/wiki/JSON_Messages#book_offers)**
...
**[requestTransactionEntry(hash, [ledger_hash], [callback])](https://xdv.io/wiki/JSON_Messages#transaction_entry)**

Searches a particular ledger for a transaction hash. Default ledger is the open ledger.

**[requestTransaction(hash, [callback])](https://xdv.io/wiki/JSON_Messages#tx)**

Searches ledger history for validated transaction hashes.

**[requestSign(secret, tx_json, [callback])](https://xdv.io/wiki/JSON_Messages#sign)**

Sign a transaction. *Requires trusted remote*

**[requestSubmit([callback])](https://xdv.io/wiki/JSON_Messages#submit)**
...
**[pathFind(src_account, dst_account, dst_amount, src_currencies)](https://xdv.io/wiki/JSON_Messages#path_find)**
